...
SETTINGS_SCHEMA = [
    ...
    },
    {
        ...
        "settings": [
            ...
            {
                "key": "SENTENCE_WRITING_MIN_BOX",
                "name": "Sentence writing unlocks at box",
                "description": "Minimum box level for 'write your own sentence' mode.",
                "type": "int",
                "default": 2,
                "min": 1,
                "max": 5,
            ...
            {
                "key": "SENTENCE_WRITING_PROBABILITY",
                "name": "Sentence writing probability",
                "description": "How often eligible words get sentence writing mode (0.0–1.0).",
                "type": "float",
                "default": 0.3,
                "min": 0.0,
                "max": 1.0,
